...
<html lang="en">
  <head>
    ...
    <style>
      ...
      .glass-background {
        margin-right: 135px;
        background-color: rgba(177,217,224, 0.3);
...
<form action="" method="post">
 ...
 <!-- CREATE TABLE `login`.`orgchartdetail` (`id` INT NOT NULL , `name` TEXT NOT NULL , `title` TEXT NOT NULL , `pid` INT NOT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB; -->